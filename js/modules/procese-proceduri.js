...
// Link direct spre Google Drive folder 03. Procese & Proceduri
// ============================================================
const ProceseProc = {
  ...
  render() {
    ...
    container.innerHTML = `
      ...
      <div style="background:var(--card-bg);border:1px solid var(--border);border-radius:12px;padding:32px;text-align:center;max-width:480px;margin:0 auto">
        ...
        <h3 style="font-size:18px;font-weight:700;margin:0 0 8px;color:var(--text)">Procese & Proceduri IC</h3>
        <p style="font-size:14px;color:var(--text-muted);margin:0 0 24px;line-height:1.6">
          Procesele și procedurile interne ale companiei sunt disponibile în Google Drive.<br>
